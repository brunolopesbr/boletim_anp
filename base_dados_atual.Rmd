...
```
Dataframes 1 a 3 dizem respeito a outros dados, não devem ser unidos. Colocando dataframes vazios no lugar deles. 

```{r}
lista_guia3_todas[[1]][[5]] <- data.frame()
lista_guia3_todas[[2]][[5]] <- data.frame()
lista_guia3_todas[[3]][[5]] <- data.frame()
...
```{r}
# Apagar colunas que não fazem sentido
lista_guia3_todas[[76]][[5]]
lista_guia3_todas[[75]][[5]]


lista_guia3_todas[[4]][[5]]
...
i <- 1
for(i in seq_along(lista_guia3_todas)){
names(lista_guia3_todas[[i]][[6]]) <- names(lista_guia3_todas[[1]][[6]])
  i <- 1 + 1
}
...
i <- 1
for(i in seq_along(lista_guia3_todas)){
lista_guia3_todas[[i]][[6]] <- select(lista_guia3_todas[[i]][[6]], !"Nº")
  i <- 1 + 1
}
...
```
Nomes precisam ser acertados manualmente
```{r}
map_df(lista_guia3_todas, `[[`, 6)
```
