...
```{r}
dfa <-  map_df(lista_guia3_versao_atual, `[[`, 4) |> 
  select(!`Nº`)

i <- 1
for(i in seq_along(lista_guia3_versao_menos1)){
lista_guia3_versao_menos1[[i]][[4]] <- lista_guia3_versao_menos1[[i]][[4]] |> 
  select(!`Nº`)  
i <- 1 + 1
}

dfb <- map_df(lista_guia3_versao_menos3, `[[`, 4)

i <- 1
for(i in seq_along(lista_guia3_versao_menos3)){
lista_guia3_versao_menos3[[i]][[4]] <- lista_guia3_versao_menos3[[i]][[4]] |> 
  select(!`Nº`)  
i <- 1 + 1
}

dfc <- map_df(lista_guia3_versao_menos3, `[[`, 4) 

por_concessionario <- bind_rows(dfa, dfb, dfc)
```
