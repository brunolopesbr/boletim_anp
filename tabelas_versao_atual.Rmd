...
```{r}
Historico_petroleo |> 
  write_csv("csv/tabela1_Historico_petroleo.csv", )

Historico_prod_gas |> 
  write_csv("csv/tabela2_Historico_prod_gas.csv")

MOVIMENTACAO_DE_GAS_NATURAL |> 
  write_csv("csv/tabela3_MOVIMENTACAO_DE_GAS_NATURAL.csv")

Historico_de_Producao_de_Petroleo_Gas_Natural |> 
  write_csv("csv/tabela4_Historico_de_Producao_de_Petroleo_Gas_Natural.csv")

por_estado |> 
  write_csv("csv/tabela5_Producao_por_estado.csv")

por_bacia |> 
  write_csv("csv/tabela6_Producao_por_bacia.csv")

por_operador |> 
  write_csv("csv/tabela7_Producao_por_operador.csv")

por_concessionario |> 
  write_csv("csv/tabela8_Producao_por_concessionario.csv")

MOVIMENTACAO_GAS_NATURAL_POR_DESTINO |> 
  write_csv("csv/tabela9_MOVIMENTACAO_GAS_NATURAL_POR_DESTINO.csv")
