...
extrair_tabelas_2018_ws3 <- function(nume, ajuste = 2, ajuste2 = -2, sheet = 3){
mes_boletim <- datas_arquivos[[nume,1]]
...
#}
 ...
 assign(x = paste0("dataf", 7), value = read_excel(paste0("data/", planilhas[nume]), sheet = 3, skip = corte[7] + ajuste) |> 
          mutate(mes = mes_boletim))  
