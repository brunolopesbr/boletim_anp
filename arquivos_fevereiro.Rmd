...
# Acertar nomes de colunas das tabelas 16 e 17

```{r}
names(lista_fev_2024[[16]]) <- names(lista_fev_2024[[16]]) |> str_squish()
names(lista_fev_2024[[17]]) <- names(lista_fev_2024[[17]]) |> str_squish()
```

```{r}
names(lista_fev_2024[[17]])
names(base_atual[[17]])
```
