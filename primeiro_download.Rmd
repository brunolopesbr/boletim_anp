...
Em seguida criamos uma função para inspecionar esse objto e produzir uma tabela com o número de links por ano.
```{r}
...
anos <- 2017:2024 %>% as.character()
numero_planilhas <- map_df(anos, inspecionar)
numero_planilhas
```
