...
for(i in seq_along(lista_guia4_todas)){
  ...
  if( names(lista_guia4_todas[[i]][[1]]) |> 
  str_detect("Nº") |> sum() > 0 ) {lista_guia4_todas[[i]][[1]] <- lista_guia4_todas[[i]][[1]] 
  |> select(!"Nº")}
...
lista_guia4_todas[[4]][[1]] 

if( names(lista_guia4_todas[[4]][[1]]) |> 
  str_detect("Nº") |> sum() > 0 ) {lista_guia4_todas[[4]][[1]] <- lista_guia4_todas[[4]][[1]] |> select(!"Nº")}
